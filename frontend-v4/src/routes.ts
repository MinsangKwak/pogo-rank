...
export const ROUTE_DESC: Partial<Record<RouteId, string>> = {
  ...
  eggs: '알의 거리와 획득 경로별 부화 포켓몬을 확인해 보세요.',
  ivrank: '내 포켓몬의 개체값이 리그별로 몇 위인지 비교해 보세요.',
  'pvp-deck': '상대 포켓몬을 최대 3마리 선택하면 맞춤 덱을 추천해요.',
  'dmax-deck': '보스 타입에 맞춰 맥스 배틀에 사용할 포켓몬 3마리를 추천해요.',
  ...
  settings: '화면 테마와 이미지 움직임을 설정해 보세요. 계정 저장 여부는 아래에서 확인할 수 있어요.',
};
