...
const THEME_TEXT: Record<Theme, [string, string]> = {
  system: ['기기 설정 따름', '기기의 밝게·어둡게 설정에 맞춰요.'],
  ...
  return (
    <p className="dex__hint">
      ...
      {status === 'anon' && enabled
        ...
        : '승인 후에는 계정에 저장한 설정을 다른 기기에서도 사용할 수 있어요.'}
      {consentOpen ? (
...
export default function Settings() {
  ...
  return (
    <div className="page__body" id="page-settings" data-route="settings">
      ...
      <SavedWhere />
      <p className="detail__foot">상단의 테마 버튼으로 밝게·어둡게를 전환할 수 있어요. 기기 설정에 맞추려면 여기서 선택해 주세요.</p>
