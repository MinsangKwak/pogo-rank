  ...
  return (
    <div className="page__body" id="page-privacy" data-route="privacy">
      ...
      <Sec title="4. 처리위탁과 국외 이전">
        <p>화면은 파일만 내려주는 정적 사이트이고, 계정과 기록은 아래에 맡깁니다. 2026-09-28 부터 검색어 기록을 받는 수집 서버와, 사용자 데이터 백업본을 두는 곳이 더해졌습니다 — 운영자가 직접 만든 서버이지만 그것이 도는 곳과 데이터베이스는 아래 업체입니다. 이용자가 로그인·동의하거나 검색어가 기록될 때 네트워크를 통해 전송됩니다.</p>
