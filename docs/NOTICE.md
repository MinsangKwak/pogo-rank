...
[← README](../README.md) · [기여 안내](../.github/CONTRIBUTING.md) · **NOTICE** · [SECURITY](../.github/SECURITY.md)
...
권리자의 요청이 있으면 해당 이미지·데이터를 즉시 삭제합니다 (아래 5. takedown).
...
- 기여는 이 저장소에 이슈 또는 PR을 제출하는 방식으로 진행합니다 ([기여 안내](../.github/CONTRIBUTING.md)).
...
1. 요청 접수 후 **72시간 안에** 해당 이미지·데이터를 `deploy` 에서 삭제한 후 배포합니다.
2. 저장소 이력에 남은 사본은 요청 범위에 따라 이력 정리(history rewrite)까지 진행합니다.
3. 접수 창구는 사이트 푸터의 문의 이메일 또는 GitHub Issues (.github/SECURITY.md 의 창구와 같습니다).
