...
(async () => {
  ...
  ok('잠긴 메뉴 줄이 정확히 여덟', lockedLabels.join('|') === '육성 플래너|레이드 · PvE|배틀 · PvP|이벤트 일정|레이드 보스|알 부화|검색식 만들기|PvP 개체값 순위', lockedLabels.join('|'));
  ...
  ok('잠긴 홈 타일도 여덟', lockedTiles.length === 8, lockedTiles.join('|'));
