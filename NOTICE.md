...
**결론: 이 저장소의 코드는 저작권자 소유이며 포크, 재배포는 안 된다(LICENSE). 포켓몬 데이터·이미지·명칭과 제3자 데이터는 각 권리자의 것이다.** 아래는 경로별 범위와 출처별 조건이다. (2026-09-07 v2.18.0 신설 · 2026-09-16 v3.48.2 MIT 에서 전환)
