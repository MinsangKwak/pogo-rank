...
// #app-title 의 textContent 는 여전히 'moncamp' 이다 (2026-09-14 v3.26.0 POGO PLAN → monlab, v3.27.0 → moncamp)
const appLogo = el('button', { type: 'button', id: 'app-logo', class: 'app-bar__logo',
  onclick: () => goHome() }, 'moncamp');
...
const versionMeta = el('p', { class: 'drawer__meta' }, 'moncamp · ' + version);
