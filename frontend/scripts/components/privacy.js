  ...
  return el('div', { class: 'page-body' },
    ...
    sec('2. 자동으로 수집되는 항목',
      ul(
        ...
        '브라우저 로컬 저장소(localStorage) — 패치노트 읽음 여부, 도감 열 수, 마지막으로 보던 탭·모드, 즐겨찾기 카드 접힘, 일정 분류, 통계 동의 여부, 약관 동의 버전. 전부 pogo_ 로 시작하는 설정값이며 개인정보가 아닙니다. 브라우저의 사이트 데이터 삭제 또는 ☰ 메뉴 → 통계·저장소 설정 → 캐시 비우기로 지울 수 있습니다',
