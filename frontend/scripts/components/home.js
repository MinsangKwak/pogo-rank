...
function renderServiceHome() {
  ...
  const features = [
    ...
    // 2026-09-12 v2.63.0 '타입 & 상성' 타일을 뺐다 — 상세 팝업이 같은 표를 이미 보여 준다.
    // 'PvP 개체값 순위' 도 뺀다: 배틀 · PvP 안의 버튼으로 들어갔다 (문을 두 개 두지 않는다)
    ['03', 'D-MAX', '맥스 배틀의 딜러와 탱커', 'dmax'],
    ['04', '레이드 · PvE', '추천 딜러와 솔플 계산기', 'pve'],
    ['05', '배틀 · PvP', '리그별 순위와 덱 구성', 'pvp'],
    ['06', '이벤트 일정', '다가오는 레이드와 이벤트', 'schedule'],
    ['07', '레이드 보스', '지금 도는 보스와 약점', 'raids'],
    ['08', '알 부화', '거리별로 뭐가 나오나', 'eggs'],
