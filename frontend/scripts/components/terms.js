...
function renderTermsPage() {
  ...
  return el('div', { class: 'page__body' },
    ...
    sec('1. 서비스란',
      ...
      ul('무료입니다. 유료 기능은 없습니다. 회원(Google 로그인 + 운영자 승인)은 광고 없이 모든 화면을 보고, 회원이 아니면 일부 화면은 광고(약 15초)를 끝까지 본 뒤 2시간 동안 열립니다(하루 3번)',
         '도감·순위표 일부는 로그인 없이 볼 수 있고, 저장 기능(내 포켓몬 · 검색식)과 회원 화면은 Google 로그인 + 운영자 승인이 필요합니다',
