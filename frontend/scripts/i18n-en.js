...
const I18N_EN = {
  ...
  "포켓몬 정보부터 배틀 준비까지, 필요한 기능을 한곳에서 찾아보세요.": "Find, compare, raise. Jump straight to the screen you need.",
  "이름·타입으로 포켓몬을 찾고 종족값과 상성을 확인해 보세요.": "Look up a Pokémon to see base stats and type matchups.",
  "맥스 배틀에 사용할 포켓몬의 등급과 역할별 순위를 비교해 보세요.": "Tier list for Dynamax and Gigantamax battles.",
  "레이드에 적합한 공격 포켓몬을 찾고 솔플 가능성을 계산해 보세요.": "Recommended attackers, and whether you can solo the raid.",
  "리그별 순위를 비교하고 상대에 맞는 덱을 구성해 보세요.": "Rankings and team ideas for each league.",
  "공식 발표를 바탕으로 게임 규칙·밸런스 변경과 오류 수정 소식을 전해요.": "News about rule, balance and bug changes in the game. Only what we confirmed against an official announcement.",
  "레이드와 이벤트 일정을 날짜별로 확인해 보세요.": "Upcoming raids and events.",
  ...
  "상대 포켓몬을 최대 3마리 선택하면 맞춤 덱을 추천해요.": "Name three opponents and we will pick a team to answer them.",
  "보스 타입에 맞춰 맥스 배틀에 사용할 포켓몬 3마리를 추천해요.": "Pick a Max Battle boss and we pick the three to bring.",
  "레이드 보스와 덱을 선택해 혼자 클리어할 수 있을지 계산해 보세요.": "Work out whether you can solo this boss.",
  "원하는 조건을 선택해 포켓몬 GO에서 사용할 검색식을 만들어 보세요.": "Tap conditions to build a string you can paste into the in-game search.",
  "moncamp의 기능 추가와 개선·수정 내역을 확인해 보세요.": "A record of what changed and when.",
  ...
  "거다이맥스를 제외하고 다이맥스 포켓몬만 추천해요": "Leaves Gigantamax forms out of the candidates — for when you have not caught one yet",
  ...
  "사탕 수 등 버전에 따라 지원 여부가 달라지는 조건도 제외했어요.": "Syntax that changes between game versions (candy counts and so on) is left out, so we never hand you a string that does not work.",
  ...
  "종합 점수 순 · 초당 피해량(DPS)과 총 피해량(TDO) 기준": "By overall score · DPS and staying power (TDO) together",
  ...
  "최적 개체값은 포켓몬과 리그에 따라 달라요.": "That is why spreads like 0/15/15 often come out on top.",
  "포켓몬 선택": "Which Pokémon?",
  "획득 경로": "Where did you get it?",
  "포켓몬을 선택하면 해당 리그의 개체값 순위를 확인할 수 있어요.": "Pick a species on the left to see its ranking in the selected league.",
  ...
  "베스트 버디의 레벨 보너스(+1)는 계산에서 제외해요.": "Best Buddy (+1 level) is left out — not everyone can get it.",
  ...
  "이벤트 기간 한눈에 보기": "All the dates at a glance",
  "기기의 밝게·어둡게 설정에 맞춰요.": "Goes dark whenever your phone or computer does.",
  "항상 밝은 테마로 표시해요.": "Always light, whatever your device says.",
  "항상 어두운 테마로 표시해요.": "Always dark, whatever your device says.",
  ...
  "공격 포켓몬을 추가하면 덱의 예상 클리어 시간을 계산해요.": "Add attackers and we tell you whether this team can win.",
  "🙅 계산상 솔플이 어려워요": "🙅 A solo clear looks difficult under these assumptions.",
  "추천 덱을 부활시켜 재투입해도": "even cycling the very best picks with unlimited revives,",
  "아래는 현재 조건에서 예상 클리어 시간이 가장 짧은 구성이에요.": "Below is still the fastest team for chipping it down.",
