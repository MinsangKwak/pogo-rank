...
const I18N_EN = {
  ...
  // 2026-09-13 v3.25.0 광고 보고 열기 (components/adgate.js · auth.js · planner/shell.js)
  '광고 보거나, 회원가입하면 열려요': 'Watch an ad, or sign up, to open this',
  '이 화면은 회원만 볼 수 있어요. 회원이 아니면 광고를 끝까지 본 뒤 #시간 동안 전부 열려요 (하루 #번).': 'This screen is for members. Non-members can watch an ad to the end and everything opens for # hours (# times a day).',
  '회원만 볼 수 있는 화면이에요. 회원이 아니면 광고를 끝까지 본 뒤 #시간 동안 전부 열려요 (하루 #번). 회원가입은 Google 로그인 + 관리자 승인이에요.': 'This screen is for members. Non-members can watch an ad to the end and everything opens for # hours (# times a day). Signing up is a Google login plus admin approval.',
  '📺 광고 보고 다 훑어보기 (#초 광고)': '📺 Watch an ad and browse everything (# s ad)',
  '오늘 #번 남음 · 한 번에 #시간': '# left today · # hours each',
  '📺 오늘 광고 #번을 다 봤어요': '📺 You have watched all # ads for today',
  '내일 다시 볼 수 있어요 — 회원가입하면 광고 없이 늘 열려요': 'Come back tomorrow — or sign up and it stays open, no ads',
  '🔐 광고 안 보고 회원가입 후 보기': '🔐 Skip the ad: sign up and view',
  '📺 광고 보는 중': '📺 Ad playing',
  '끝까지 보면 ': 'Watch to the end and everything opens for ',
  ' 동안 전부 열려요 · ': ' · ',
  '그만 볼래요': 'Stop watching',
  '광고 준비 중': 'Ad coming soon',
  '곧 이 자리에 광고가 나와요. 지금은 시간만 셉니다': 'An ad will appear here soon. For now only the timer runs',
  '광고로 열림': 'Opened by ad',
  '광고 보는 중': 'Ad playing',
