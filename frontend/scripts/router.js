...
// 2026-09-13 v3.25.0 다시 잠근다 — 문은 둘: 광고 보고 열기(components/adgate.js) · 회원가입.
// ROUTES.locked 표는 그대로다. 다시 열어 둘 일이 생기면 아래 상수 하나만 true 로 (localStorage pogo_lock_open='off' 는 그때의 회귀용 손잡이)
...
function routeLocked(id) {
  ...
  // 2026-09-13 v3.25.0 광고 보고 연 시간 안이면 잠그지 않는다 (components/adgate.js) — 잠금을 정하는 자리가 여기 하나라 화면·메뉴·홈 타일이 함께 열린다
  if (typeof adUnlockActive === 'function' && adUnlockActive()) return false;
