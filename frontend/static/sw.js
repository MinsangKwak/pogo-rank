...
self.addEventListener('fetch', (e) => {
  ...
  } else if (url.origin === location.origin && (url.pathname.endsWith('data.js') || url.pathname.endsWith('data-lazy.js') || url.pathname.endsWith('app.js') || url.pathname.endsWith('app-lazy.js'))) {
