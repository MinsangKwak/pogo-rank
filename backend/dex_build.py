...
for path in ('data/pvp.json', 'data/pve.json', 'data/pve_easy.json', 'data/pve_by_type.json', 'data/dynamax.json', 'data/dynamax_tier.json', 'data/dynamax_tank.json', 'data/value.json', 'data/sheet.json',
