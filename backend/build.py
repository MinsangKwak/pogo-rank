...
APP_VERSION = 'v2.62.0'  # PvP 개체값 순위 — 리그 탭 · 화면 정돈
...
SCRIPTS = [
    ...
    'components/favs.js', 'components/typesearch.js', 'components/gameday.js', 'components/finder.js', 'components/ivrank.js',  # 2026-09-11 v2.58.0 finder: 🔎 검색식 만들기 (pages 가 PAGES 에 등록하므로 그 앞) # 2026-09-05 favs: ★ 즐겨찾기 페이지 · 2026-09-06 typesearch: 🧭 상성 검색 페이지 · 2026-09-08 gameday: ⚔️ 레이드 보스 · 🥚 알 부화 (pages가 PAGES에 등록하므로 그 앞)
