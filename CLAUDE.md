...
| 무엇 | 격자 | 왜 |
| --- | --- | --- |
| 글자 크기 | `1.1` · `1.4` · `2.2` · `2.8` · `4.2` rem | Galmuri 가 그려진 11·14px 의 정수배. 15·16·18 을 쓰면 픽셀이 뭉개져 그냥 흐린 글씨가 된다 |
...
크기가 아니라 **굵기**로 가른다 — 15·16·18 을 끼워 넣으면 다시 흐려진다.

v4.3.4 에 크기 474군데·간격 1484군데를 이 격자로 스냅했다. 새로 적을 때도 격자 위 값만 쓴다.
